...
import (
	...
	zhanggqtechv1beta1 "github.com/kubebuilder-demo/api/v1beta1"
...
//+kubebuilder:rbac:groups=zhanggq.tech.zhanggq.tech,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=zhanggq.tech.zhanggq.tech,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=zhanggq.tech.zhanggq.tech,resources=apps/finalizers,verbs=update
...
func (r *AppReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, types.NamespacedName{Name: app.Name, Namespace: app.Namespace}, s); err != nil {
		if errors.IsNotFound(err) && app.Spec.EnableServer {
...
// owns设置之后，deployment以及ingress和service发生变化后reconsiler就会调用
func (r *AppReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&zhanggqtechv1beta1.App{}).
		Owns(&v1.Deployment{}).
		Owns(&netingress.Ingress{}).
		Owns(&corev1.Service{}).
		Complete(r)
}
