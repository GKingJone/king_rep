...
//+kubebuilder:webhook:path=/mutate-zhanggq-tech-zhanggq-tech-v1beta1-app,mutating=true,failurePolicy=fail,sideEffects=None,groups=zhanggq.tech.zhanggq.tech,resources=apps,verbs=create;update,versions=v1beta1,name=mapp.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-zhanggq-tech-zhanggq-tech-v1beta1-app,mutating=false,failurePolicy=fail,sideEffects=None,groups=zhanggq.tech.zhanggq.tech,resources=apps,verbs=create;update,versions=v1beta1,name=vapp.kb.io,admissionReviewVersions=v1
...
func (r *App) validateApp() error {
	...
	if !r.Spec.EnableServer && r.Spec.EnableIngress {
